        ...
        <div style={{ display: "grid", gridTemplateColumns: "8fr 4fr", gap: 64 }}>
          <div className="flex flex-col gap-32">
            ...
            {isLoading ? (
              ...
              <div className="empty-state">
                <span className="material-symbols-outlined empty-state-icon" style={{ fontSize: 32 }}>gavel</span>
                <p className="text-body-lg text-on-surface-variant">No active auctions at the moment. Check back soon.</p>
              </div>
            )}
          </div>
...
export default function BidsPage() {
  ...
  return isArtist() ? <SellerBidsPage /> : <BuyerBidsPage />;
}
